@extends('layout.app')       
        ...
        @section('script-peta')
        <script src="{{asset('asset_peta/cibiru/js/qgis2web_expressions.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/leaflet.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/leaflet.rotatedMarker.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/leaflet.pattern.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/leaflet-hash.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/Autolinker.min.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/rbush.min.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/labelgun.min.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/labels.js')}}"></script>
        <script src="{{asset('asset_peta/cibiru/js/tailDT.js')}}"></script>
        ...
        map.setView(new L.LatLng(-6.920865241999934, 107.719091352000078), 14);
        function pop_kdkec_110_1(feature, layer) {
            layer.on({
                mouseout: function(e) {
        ...
        function style_kdkec_110_1_0() {
            return {
                pane: 'pane_kdkec_110_1',
                opacity: 1,
        ...
        map.createPane('pane_kdkec_110_1');
        map.getPane('pane_kdkec_110_1').style.zIndex = 401;
        map.getPane('pane_kdkec_110_1').style['mix-blend-mode'] = 'normal';
        var layer_kdkec_110_1 = new L.geoJson(json_kdkec_110_1, {
            attribution: '',
            interactive: true,
            dataVar: 'json_kdkec_110_1',
            layerName: 'layer_kdkec_110_1',
            pane: 'pane_kdkec_110_1',
            onEachFeature: pop_kdkec_110_1,
            style: style_kdkec_110_1_0,
        });
        bounds_group.addLayer(layer_kdkec_110_1);
        map.addLayer(layer_kdkec_110_1);
        setBounds();
        ...
        function filterFunc() {
          ...
          this[lyr["options"]["layerName"]].addData(features);
            ...
            nmdesa_options_str  += '<option value="CIPADUNG">CIPADUNG</option>';
            nmdesa_options_str  += '<option value="CISURUPAN">CISURUPAN</option>';
            nmdesa_options_str  += '<option value="PALASARI">PALASARI</option>';
            nmdesa_options_str  += '<option value="PASIR BIRU">PASIR BIRU</option>';
